                ...
                <table class="auto-style4">
                    <tr>
                        <td style="background-color: #99FFCC; text-align: center;">
                          ...
                          <a href="YemekDetay.aspx?yemekid=<%#Eval("yemekid") %>"><asp:Label ID="Label3" runat="server" Text='<%# Eval("YemekAd") %>' style="font-size: x-large; text-align: center; color: #FF3300; background-color: #99FFCC;"></asp:Label></a>
                    ...
                    <tr>
                        <td>
                            Malzemeler<strong> :</strong><asp:Label ID="Label4" runat="server" Text='<%# Eval("YemekMalzeme") %>'></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            YemekTarifi :<asp:Label ID="Label5" runat="server" Text='<%# Eval("YemekTarif") %>'></asp:Label>
                        </td>
                    </tr>
                    <strong>
                    <tr>
